tsParticles.load({
  ...
  options: {
    ...
    background: {
      color: { value: "#f1f1f1" },
      image: "https://images.rawpixel.com/image_800/cHJpdmF0ZS9sci9pbWFnZXMvd2Vic2l0ZS8yMDIyLTA1L3B4MTU4NDgwMy1pbWFnZS1rd3Z4dmxjai5qcGc.jpg",
      position: "center",
      repeat: "",
      size: "cover",
      opacity: 1
    ...
    interactivity: {
      ...
      modes: {
        ...
        connect: { distance: 80, links: { opacity: 1 }, radius: 60 },
        grab: {
          distance: 400,
        ...
        light: {
          ...
          shadow: { color: { value: "#f00" }, length: 2000 }
        }
      }
    },
    manualParticles: [],
    particles: {
      ...
      links: {
        ...
        triangles: { enable: true, frequency: 1 },
        width: 1,
        warp: false
      },
      repulse: {
